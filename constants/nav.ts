...
export const shopMenuGroups: MenuGroupType[] = [
    {
        title: 'Shop Layout',
        items: [
            { label: 'Default Grid', href: '/shop_layout/grid_4' },
            { label: 'Default List', href: '/shop_layout/grid_1' },
            { label: 'Full Width List', href: '/shop_layout/grid_1' },
            { label: 'Full Width Grid', href: '/shop_layout/grid_4' },
            { label: 'Left Sidebar', href: '/shop_layout/left_sidebar' },
            { label: 'Right Sidebar', href: '/shop_layout/right_sidebar' },
            { label: 'Filter Dropdown', href: '/shop_layout/filter_dropdown' },
            { label: 'Filter Canvas', href: '/shop_layout/grid_4' },
        ],
    },
    {
        title: 'Shop Features',
        items: [
            { label: 'Categories Top 1', href: '/shop_features/categories_top_1' },
            { label: 'Categories Top 2', href: '/shop_features/categories_top_2' },
            { label: 'Shop Collection', href: '/shop_features/shop_collection' },
            { label: 'Book Collection', href: '/shop_features/book_collection' },
            { label: 'Breadcrumb IMG', href: '/shop_features/breadcrumb_img' },
            { label: 'Breadcrumb Left', href: '/shop_features/breadcrumb_left' },
            { label: 'Breadcrumb BG', href: '/shop_features/breadcrumb_bg' },
            { label: 'Load Button', href: '/shop_features/load_button' },
            { label: 'Pagination', href: '/shop_features/pagination' },
            { label: 'Infinite Scrolling', href: '/shop_features/infinite' },
        ],
    },
    {
        title: 'Products Hover',
        items: [
            { label: 'Product Style 1', href: '/product_hover/style_1' },
            { label: 'Product Style 2', href: '/product_hover/style_2' },
            { label: 'Product Style 3', href: '/product_hover/style_3' },
            { label: 'Product Style 4', href: '/product_hover/style_4' },
            { label: 'Product Style 5', href: '/product_hover/style_5' },
            { label: 'Product Style 6', href: '/product_hover/style_6' },
            { label: 'Product Style 7', href: '/product_hover/style_7' },
        ],
    },
    {
        title: 'My Pages',
        items: [
            ...
            { label: 'Search Result', href: '/search_result' },
