    ...
    return (
        <div className="grid lg:grid-cols-2 gap-5">
            {saveUpItems.map((item, index) => (
                <div key={index}
                    className="flex flex-col md:flex-row items-center gap-5 bg-[#EFF0F280] p-5 rounded-xl">
                    ...
                    <div className="sm:w-1/2 xl:w-[40%] gap-y-4 text-center flex flex-col items-center justify-center">
                        ...
                        <h6 className="uppercase text-gray-600 text-[13px]">{item.label}</h6>

                        <h3 className="capitalize font-semibold text-lg md:!text-xl">
                            {item.title}
                        </h3>

                        <div className="mx-auto border border-primary text-primary font-medium px-3 py-1 rounded-md text-sm max-w-max">
                            {item.price}
                        </div>
