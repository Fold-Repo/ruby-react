...
import { Breadcrumb, Button, Container, QuantitySelector, StarRating, Tab } from '@/components'
...
import { ProductDesc, ProductReview, ProductsPolicy, ShippingAndReturn } from '../components'
...
const DescWidthView = () => {
  ...
  const { title, price, description, oldPrice, sizes = [], images = [], colors = [], category, ratingAverage,
    ratingTotal, stock, sku, deliveryEstimate, vendor, ratingsBreakdown, reviews = [] } = product || {};
        ...
        <div className="section-lg space-y-20">
          ...
          {isLoading ? (
            ...
            <>
              ...
              {/* ====== PRODUCTS DETIALS TAB  =======*/}
              <div>

                  <Tab active={activeTab} direction="row" tabs={[
                    { key: "review", title: "Customers Reviews" },
                    { key: "desc", title: "Description" },
                    { key: "policy", title: "Return policies" },
