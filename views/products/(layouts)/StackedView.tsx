...
import { ColorSwatchGroup, ProductInfoSection, ProductTop, SizeBadgeGroup, StackProductGallery } from '@/components/product'
...
import { ProductDetailsSkeleton, StackGallerySkeleton } from '@/components/skeleton'
                    ...
                    { isLoading ? (
                        ...
                        <>
                            ...
                            <div className="grid lg:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-4 lg:sticky top-24 h-fit self-start">
