          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="grid lg:grid-cols-2 gap-10">
                ...
                <ProductImageGallery thumbPosition='right' images={combinedImages}
                ...
                <div className="w-full">
                  ...
                  <div className="space-y-4 mb-10">
                    ...
                    {(price || oldPrice) && (
                      <div className="items-center flex gap-x-3 text-base md:text-lg font-medium">
                        {price && <p className="text-primary">${price.toFixed(2)}</p>}
                  ...
                  <ProductDetailsAccordions desc={description}
                    ratingsBreakdown={ratingsBreakdown} reviews={reviews}
...
const LoadingScreen = () => (
  <div className="grid lg:grid-cols-2 gap-10">
    ...
    <ProductImageGallerySkeleton thumbPosition='right' />
...
export default FixedScrollsView