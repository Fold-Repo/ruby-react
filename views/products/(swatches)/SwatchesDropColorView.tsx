...
import { ProductImageGallery, ProductInfoSection, ProductTop, ProductVariantDropdown, SizeBadgeGroup } from '@/components/product'
...
export default SwatchesDropColorView