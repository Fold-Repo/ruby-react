...
const SwatchesRoundedColorView = () => {
                                   ...
                                   {(price || oldPrice) && (
                                    ...
                                    {colors.length > 0 && (
                                        <div className="flex flex-col gap-y-3">
                                            ...
                                            <ColorSwatchGroup variant='label-color' value={selectedColor} colors={colors}
                                                onClick={(color) => {
                                    ...
                                    {sizes.length > 1 && (
                                        <div className="flex flex-col gap-y-3">
                                            ...
                                            <SizeBadgeGroup variant='rounded-full' onClick={(s) => setSelectedSize(s)} value={selectedSize}
...
export default SwatchesRoundedColorView