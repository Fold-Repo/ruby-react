...
import { ColorSwatchGroup, ProductImageGallery, ProductInfoSection, ProductTop, SizeBadgeGroup, SubAndSave } from '@/components/product'
...
const SubscribeView = () => {
    ...
    const handleCartAndBuy = (redirect = false) => {
        dispatch(addToCart({
            ...
            discountPercent: subscriptionDetails.discountPercent,
                            ...
                            <div className="grid lg:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-4">
                                   ...
                                   {(price || oldPrice) && (
                                    ...
                                    <SubAndSave onChange={setSubscriptionDetails} />
