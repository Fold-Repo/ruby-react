...
import { ColorSwatchGroup, CountdownOfferCard, ProductImageGallery, ProductInfoSection, ProductTop, SizeBadgeGroup } from '@/components/product'
...
const PreOrdersView = () => {
    ...
    const { product, frequentlyBoughtTogether, related, isLoading } = useProductDetails(productId || '');
                            ...
                            <div className="grid lg:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="flex items-center justify-between gap-3 flex-wrap">
                                      ...
                                      <Chip className='text-xs' color='primary' size='md'>Pre-Order</Chip>
                                  ...
                                  <CountdownOfferCard targetDate={new Date(Date.now() + 5 * 24 * 60 * 60 * 1000)}
                                    soldPercentage={75}
                                    itemsLeft={10} />
