...
import { ColorSwatchGroup, CustomerNote, ProductImageGallery, ProductInfoSection, ProductTop, SizeBadgeGroup } from '@/components/product'
...
const CustomerNoteView = () => {
    ...
    const handleCartAndBuy = (redirect = false) => {
        ...
        if (!note && !file) {
            toast.error('Please add a note or upload a file to personalize your item.');
            return;
        }
...
export default CustomerNoteView