...
import { ColorSwatchGroup, MaterialSwatch, ProductImageGallery, ProductInfoSection, ProductTop, SizeBadgeGroup } from '@/components/product'
...
const VariableView = () => {
    ...
    const { title, price, description, oldPrice, sizes = [], images = [], colors = [], category, ratingAverage,
        ratingTotal, stock, sku, deliveryEstimate, vendor, materials = [] } = product || {};
    ...
    const finalPrice = (price || 0) + materialPrice;
                    ...
                    { isLoading ? (
                        ...
                        <>
                            ...
                            <div className="grid lg:grid-cols-2 gap-10">
                                ...
                                <ProductImageGallery thumbPosition='left' images={combinedImages}
                                ...
                                <div className="space-y-4">
                                    ...
                                    {/*  ==== PRICE ====  */}
                                    {(price || oldPrice || materialPrice) && (
                                        <div className="items-center flex gap-x-3 text-base md:text-lg font-medium">
                                            {price && <p className="text-primary"> { formatCurrency(finalPrice) } </p>}
                                    ...
                                    {materials.length > 0 && (
                                        <div className="flex flex-col gap-y-3">
                                            <label className='text-sm font-medium' htmlFor="size"> Material:
                                                {selectedMaterial && <span className="font-bold">: {selectedMaterial?.name} </span>}
                                            </label>
                                            <MaterialSwatch value={selectedMaterial?.name} material={materials}
                                                onClick={(material) => {
