...
import { ColorSwatchGroup, NotifyStock, ProductImageGallery, ProductInfoSection, ProductTop, SizeBadgeGroup } from '@/components/product'
...
const OutStockView = () => {
    ...
    const { id, title, price, description, oldPrice, sizes = [], images = [], colors = [], category, ratingAverage,
                            ...
                            <div className="grid lg:grid-cols-2 gap-10">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex flex-col gap-y-3">
                                        ...
                                        <QuantitySelector disabled={!stock} value={qty} onChange={setQty} />
                                    </div>
