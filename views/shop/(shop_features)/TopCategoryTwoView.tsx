...
import { CategoryCardTwo, ProductCard, ProductListCard } from '@/components/cards'
import { SwiperCarousel, SwiperDots, SwiperSlide } from '@/components/carousel'
import { CategoryCardTwoSkeleton, ProductCardSkeleton, ProductListCardSkeleton } from '@/components/skeleton'
import { useQueryParams } from '@/hooks'
import { useGetProductsMetas, useGetTopCategories, useProductQuery } from '@/service'
import { CategoryType, ProductType } from '@/types'
import React from 'react'

const TopCategoryTwoView = () => {
                    ...
                    <div className="">
                        ...
                        <SwiperCarousel
                            ...
                            { loadingCat
                                ...
                                : categories?.category_2?.map((cat: CategoryType, index: number) => (
                                    <SwiperSlide key={index}>
                                        <CategoryCardTwo category={cat} />
                                    </SwiperSlide>
                                ))}
...
export default TopCategoryTwoView