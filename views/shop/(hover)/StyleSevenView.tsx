                    ...
                    <ResponsiveGrid columns={grid}>
                        ...
                        {isLoading
                            ...
                            : products?.map((item: ProductType, index: number) =>
                                grid === '1' ? (
                                    <ProductListCard styeType="style7" key={index} product={item} />
                                ) : (
                                    <ProductCard styleType="style7" key={index} product={item} />
                                )
                            )
                        }
