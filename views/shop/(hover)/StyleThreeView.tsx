                    ...
                    <ResponsiveGrid columns={grid}>
                        ...
                        {isLoading
                            ...
                            : products?.map((item: ProductType, index: number) =>
                                grid === '1' ? (
                                    <ProductListCard styeType="style3" key={index} product={item} />
                                ) : (
                                    <ProductCard styleType="style3" key={index} product={item} />
                                )
                            )
                        }
