...
const ContactDetails = () => {
    return (
        <div className="bg-white-smoke dark:bg-gray-800 px-5 py-8 rounded-xl">

            <div className="max-w-4xl m-auto flex flex-col space-y-7">

                <div className="space-y-4">

                    <h1 className="font-bold text-lg lg:!text-xl text-center text-black dark:text-white">
                        📩 Contact Ruby
                    </h1>

                    <p className="text-sm text-black/80 dark:text-white/80 text-center">
                ...
                <div className="grid md:grid-cols-2 gap-5 text-sm font-semibold">
                    ...
                    <div className="space-y-5">
                        <p>
                            <b> Phone:{" "}</b>
                            <a className="underline text-primary dark:text-primary-light" href="tel:+44 1234 567 890">
                                +44 1234 567 890
                            </a>
                        </p>
                        ...
                        <p>
                            <b> Email:{" "}</b>
                            <a className="underline text-primary dark:text-primary-light" href="mailto:support@rubyfashion.co.uk">
