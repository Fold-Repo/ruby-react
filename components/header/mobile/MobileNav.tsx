            ...
            <AnimatePresence>
                {open && (
                    <>
                        ...
                        {/* Slide-in Menu */}
                        <motion.aside
                            className="fixed left-0 top-0 z-50 h-full w-[min(20rem,90vw)] bg-gray-900 text-white shadow-2xl ring-1 ring-black/20 overflow-y-auto"
                            initial={{ x: '-100%' }}
                            animate={{ x: 0 }}
                            exit={{ x: '-100%' }}
                        ...
                        >
                            <div className="flex justify-between items-center py-3 px-4 border-b border-gray-700">
                                <Link href="/" className="logo-header">
                                    <Image width={153} height={63} src="/img/logo/white_logo.png" alt="logo" className="logo w-24 md:w-32" />
                                </Link>

                                <button onClick={close} type="button" className="bg-gray-700 rounded-full size-7 text-sm flex items-center justify-center cursor-pointer">
                                    <XMarkIcon className='size-4 text-white' />
                                </button>
                            </div>

                            <div className="divide-y divide-gray-700 p-5">
                                ...
                                <div className="flex items-center gap-2 mt-12">
                                    ...
                                    <Button className='bg-gray-700 text-white w-full' rounded='lg' leftIcon={<HeartIcon className='size-4' />}>
                                        Wishlist
                                    </Button>
