...
const BookProductCardFour: React.FC<BookProductCardFourProps> = ({ product }) => {
    ...
    return (
        <div className="flex flex-col border border-gray-200 rounded-xl">
            ...
            <div className="bg-gray-100 p-3 h-full rounded-lg space-y-3">
            ...
            {/* Book Details */}
            <div className="p-5 space-y-2.5 flex flex-col justify-center text-center">
                ...
                <div className="flex items-center justify-center sm:justify-between flex-wrap gap-2 capitalize text-slate-500 text-[12px] md:!text-sm">
                    <span>
