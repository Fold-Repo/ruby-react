...
const PostShareBar: React.FC<PostShareBarProps> = ({ tags = [], shareData }) => {
    ...
    return (
        <div className="flex items-center justify-between gap-5 flex-wrap border border-gray-300 rounded-xl p-4">

            <div className="flex items-center gap-3 flex-wrap">

                <h2 className="font-medium text-sm">Popular Tag:</h2>

                <div className="flex items-center gap-2 flex-wrap">
                    {tags.map((tag, index) => (
                        <span key={index} className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-md text-xs font-semibold border border-gray-300 bg-white text-gray-800">
                            {tag}
                        </span>
                    ))}
                </div>
            ...
            <div className="flex items-center gap-3 flex-wrap">
                ...
                <h2 className="font-medium text-sm">Share post:</h2>
