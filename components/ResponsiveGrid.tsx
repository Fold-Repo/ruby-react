...
const gridClassMap: Record<string, string> = {
    ...
    '2': 'grid-cols-2 gap-x-5 gap-y-7',
    '3': 'grid-cols-2 sm:grid-cols-3 gap-x-5 gap-y-7',
    '4': 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-x-5 gap-y-7',
    '5': 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-5 gap-y-7',
